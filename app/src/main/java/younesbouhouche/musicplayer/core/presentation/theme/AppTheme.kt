...
internal fun AppTheme(
    ...
    val theme by repository.get(SettingsPreference.ThemeMode).collectAsState(initial = Theme.SYSTEM)
    val extraDark by repository.get(SettingsPreference.ExtraDarkMode).collectAsState(initial = false)
    val isDark =
        when (theme) {
